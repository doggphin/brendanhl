...
<Post title="Devlog 1" date="01/08/2025">
    <Paragraph text="Wrong Warp is an in-development PvP MMO.
    ...
    <Paragraph text="I first attempted to create Wrong Warp in 2022, but did not have the necessary experience in network systems nor general programming to make significant progress.
    ...
    <Paragraph text="Now, with a few more years of programming knowledge under my belt -- most importantly, having taken network systems at university and written several 
    ...
    <span class="space-bottom">
        ...
        collides with an entity that has moved on the server without the client knowing about it yet. To fix this, clients save all the verified positions they've received from the server and previous inputs 
        they've given for the last second, and whenever they receive an update from the server that doesn't match their predictions, they resimulate their player from the last verified player state back to their current tick.
    </span>
    <span class="space-bottom">
    ...
    <span class="space-bottom">
        If you're still here, enjoy some fun text to speech :)
    </span>
