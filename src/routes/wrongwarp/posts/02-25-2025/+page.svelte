...
<Post title="Devlog 2" date="02/08/2025">
    <PostParagraph>
    ...
    <PostParagraph>
        ...
        Microsoft's SAM voice. It's buggy as balls and sounds terrible. I'm intentionally 
        omitting player names and plan to replace the placeholder wizard face with a 
        picture taken of the player model's head.
    </PostParagraph>
    <PostParagraph>
        With this stuff out of the way, I think I'm gonna focus on the game loop next. 
        There's no game to play yet. I'll be adding a health system, equipping weapons,
