<script lang="ts">
    ...
    import PostYoutubeVideo from "$lib/components/blog/PostYoutubeVideo.svelte";
...
<Post title="Devlog 1" date="01/08/2025">
    ...
    <PostYoutubeVideo link="https://www.youtube.com/embed/0VFI9qGvLxg?si=3YxxEwJROK5YjqJi" title="Wrong Warp 2022"/>
    <PostParagraph>
